...
<template>
    <header>
        ...
        <div class="buttons-tools">
            ...
            <SvgIcon href="https://mastodon.social/@nxus" rel="me" target="_blank" aria-label="mastodon">
            ...
            <SvgIcon href="https://bsky.app/profile/nxus.pages.dev" target="_blank" aria-label="bluesky">
